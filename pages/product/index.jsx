...
const index = () => {
  return (
    ...
    <div className="md:flex-1 md:text-start text-center">
      ...
      <span className="text-primariy text-2xl font-bold underline underline-offset-1 my-4 inline-block">
        $10
      </span>
      ...
      <div>
        ...
        <div className="flex items-center gap-x-20 md:justify-start justify-center">
          <div className="relative w-8 h-8">
            ...
            <span className="absolute top-0 -right-6 text-xs bg-primariy rounded-full px-[5px] font-medium">
              Small
            </span>
          </div>
      ...
      <div className="flex gap-x-4 my-6 md:justify-start justify-center">
        <label className="flex items-center gap-x-1">
          <input type="checkbox" className="w-5 h-5 accent-primariy" />
